    ...
    <div class="card">
        <div class="card-body p-b-0">
            ...
            <ul class="nav nav-tabs customtab" role="tablist">
                <li class="nav-item"> 
                    <a class="nav-link active" data-toggle="link" href="<?php echo base_url()?>CobaC/Dataanggota" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"> Data Anggota</span> &nbsp; 
                    </a>
                </li>
                <li class="nav-item"> 

...
<div class="main-wrapper">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Daftar Koperasi</h4><br>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($data_akun as $data) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $data->nama_akun."<br>";?></td>
                                                <td><?php echo "Email : <b>".$data->email_akun."</b><br> Password : <b>".$data->password."</b>";?></td>
                                                <td><?php echo $data->no_hp?></td>
                                                <td class="text-center">
                                                    <a href="<?php echo base_url('AdminC/detail_fitur/'.$data->id_akun)?>" class="btn btn-info btn-sm">Detail Fitur</a>

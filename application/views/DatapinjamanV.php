    ...
    <div class="card">
        <div class="card-body p-b-0">
            ...
            <ul class="nav nav-tabs customtab" role="tablist">
                ...
                <li class="nav-item"> 
                    <a class="nav-link active" data-toggle="link" href="<?php echo base_url()?>CobaC/Datapinjaman" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"> Data Pinjaman Anggota</span>&nbsp; 
                    </a> 
                </li>
                <li class="nav-item"> 
                ...
                <li class="nav-item"> 
                    <a class="nav-link" data-toggle="link" href="<?php echo base_url()?>CobaC/Datalabarugi" role="tab"><span class="hidden-sm-up"></span><span class="hidden-xs-down"> Laba Rugi</span>&nbsp;
                    </a> 
                </li>
            </ul>
            <!-- Tab panes -->
                ...
                <div class="tab-pane active  p-20" id="Dataanggota" role="tabpanel">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form>
                                <div class="p-20">
                                    <label class="control-label">Upload Data Pinjaman Anggota</label><br>
